...
def increase_inventory_task(self, my_task_tracker_id, refresh_token, current_user_id):
  ...
  try:
    ...
    if result[0] == 'SUCCESS' :
        ...
        print('Moved my task tracker to history')
